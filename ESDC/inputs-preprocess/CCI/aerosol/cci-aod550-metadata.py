...
with open("inputs-preprocess/CCI/aerosol/cci-aod550-metadata.yaml", "r") as stream:
    try:
        metadata = yaml.safe_load(stream)
    except yaml.YAMLError as exc:
        print(exc)

datacube = xr.open_zarr(f"{pathIn}/cci-aod550-8d-0.25deg-256x128x128.zarr")
...
datacube.to_zarr(f"{pathOut}/cci-aod550-8d-0.25deg-256x128x128.zarr")
