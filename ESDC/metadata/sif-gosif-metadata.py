...
datacube = xr.open_zarr("/net/projects/deep_esdl/data/GOSIF/cubes/sif-gosif-no-metadata-1x1024x1024.zarr")
...
datacube.to_zarr("/net/projects/deep_esdl/data/GOSIF/cubes/sif-gosif-1x1024x1024.zarr")