...
with open("gfed4-burntarea-metadata-0.0833deg.yaml", "r") as stream:
    try:
        metadata = yaml.safe_load(stream)
    except yaml.YAMLError as exc:
        print(exc)

datacube = xr.open_zarr("/net/scratch/dmontero/GFED4/cubes/gfed4-burntarea-8d-0.083deg-256x128x128.zarr")
...
datacube.to_zarr("/net/scratch/dmontero/GFED4/cubes/metadata/gfed4-burntarea-8d-0.083deg-256x128x128.zarr")
