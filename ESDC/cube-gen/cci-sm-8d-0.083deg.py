...
print("Reading")
dataset_8d = xr.open_zarr("/net/scratch/dmontero/CCI/cci-sm-8d-0.25deg-256x128x128.zarr")
...
print("Saving")
dataset_8d.to_zarr("/net/scratch/dmontero/CCI/cci-sm-8d-0.083deg-256x128x128.zarr")
